...
import type { Account } from '../../../app/api/graphql/graphql-server/modules/types.generated'
...
const isJestTest = process.env.IS_JEST === 'true' 
const jwtSecret = (!isJestTest ? process.env.JWT_SECRET : 'fake secret') ?? 'fake secret'
