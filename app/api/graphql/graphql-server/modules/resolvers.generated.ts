...
import    { JSONResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { allLanguages: Query_allLanguages,allRecipes: Query_allRecipes,allTags: Query_allTags,pingQuery: Query_pingQuery,validationSchemas: Query_validationSchemas },
      Mutation: { createEmailAccount: Mutation_createEmailAccount,createRecipe: Mutation_createRecipe,deleteAccount: Mutation_deleteAccount,patchRecipe: Mutation_patchRecipe,pingMutation: Mutation_pingMutation,requestVerificationEmail: Mutation_requestVerificationEmail,signInToEmailAccount: Mutation_signInToEmailAccount },
