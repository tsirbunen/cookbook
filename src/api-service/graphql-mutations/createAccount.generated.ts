...
export type CreateAccountMutation = { __typename?: 'Mutation', createAccount: { __typename: 'Account', id: number, uuid: string, username: string, phoneNumber: string, isVerified: boolean, token?: string | null } | { __typename: 'BadInputError', errorMessage: string } };
