 ...
 */
const ButtonWithTheme = ({ children, variant, label, onClick, isDisabled, isToggled }: ButtonWithThemeProps) => {
  ...
  return (
    <Button variant={variant} {...isToggledProp} onClick={onClick} isDisabled={isDisabled}>
      {content}
    </Button>
  )
}
