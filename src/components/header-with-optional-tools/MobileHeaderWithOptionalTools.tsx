...
type MobileHeaderWithOptionalToolsProps = {
  label: string
  noTools: boolean
  height: number
}

const MobileHeaderWithOptionalTools = ({ label, height, noTools }: MobileHeaderWithOptionalToolsProps) => {
  return (
...
export default MobileHeaderWithOptionalTools
