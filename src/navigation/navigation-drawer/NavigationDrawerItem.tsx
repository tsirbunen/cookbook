...
const NavigationDrawerItem = ({ iconElement, content, onClick, showDividerBelow }: DrawerNavigationMenuItemProps) => {
  ...
  return (
    <Flex flexDirection="column" marginBottom="10px" onClick={onClick} data-testid={drawerItemDataTestId}>
      ...
      {showDividerBelow ? <Divider marginTop="10px" borderColor={contentColor} borderWidth="1px" /> : null}
    </Flex>
  )
}
